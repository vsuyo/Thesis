    ...
    <ul class="x-navigation">
        ...
        <li class="xn-openable">
            ...
            <ul>
                ...
                <li><a href="Casket_inventory.php"><span class="fa fa-archive"></span>Entry For Inventories</a></li>
                <li><a href="DataEntry.php"><span class="fa fa-user"></span>Client & Deceased</a></li> 
                <li><a href="Hearse.php"><span class="fa fa-truck"></span>Hearse Driver & Car</a></li>              
        ...
        <li class="xn-openable">
            ...
            <ul>
                ...
                <li><a href="SummaryTransaction.php"><span class="fa fa-wrench"></span>Summary Transaction</a></li>
        ...
        <li class="xn-openable">
            ...
            <ul>
                <li><a href="Backup.php"><span class="fa fa-cloud-download"></span>System Backup</a></li>        
                <li><a href="changepass.php"><span class="fa fa-key"></span>Change Password</a></li>
            </ul>
        </li>
    </ul>
    <!-- END X-NAVIGATION -->
