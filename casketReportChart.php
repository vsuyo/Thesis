...
<html lang="en">
    ...
    <head>
        ...
        <?php require 'js/charteasy/casketChart.php'?>
        <!-- META SECTION -->   
        ...
        <div class="btn-group pull-left">
            <div class="btn-group">
                ...
                <ul class="dropdown-menu" role="menu">
                    <li><a href="#" onclick="oCasketName()">Casket Name</a></li>
                    <li><a href="#" onclick="oCasketType()">Casket Type</a></li>
                    <li><a href="#" onclick="oCasketColor()">Casket Color</a></li>
                </ul>
            </div>
        </div>
    ...
    if(isset($_GET['year'])){
        ...
        <div class="panel-body">
            <div id="casketChart" style="width: 100%; height: 400px"></div>
        </div>
