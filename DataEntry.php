                            ...
                            <form role="form" class="form-horizontal" method="post" enctype="multi-part/form-data">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                                <input type="text" class="form-control datepicker" name="date_added" value="Date" placeholder="Date" data-date-end-date="0d">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-5">
                                                <input type="text" class="form-control datepicker" name="birthdate" id="tbirthday" value="Date" placeholder="Date" required="" data-date-end-date="0d">
                                        </div>
                                    </div>
                                    <div class="form-group">
