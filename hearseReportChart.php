...
<html lang="en">
	...
	<head>
		...
		<title>Hearse Report</title>
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		<script src="js/jquery.min.js"></script>
		<script src = "js/jquery.canvasjs.min.js"></script>
		<?php require 'js/charteasy/hearseChart.php'?>
...
<div class="btn-group pull-center">
	...
	if(isset($_GET['year'])){
		...
		<div class="panel-body">
			<div id="hearseChart" style="width: 100%; height: 400px"></div>
		</div>
        
        <form method="post" action="HearseReport.php">
		...
		<script>
			$(document).ready(function(){
				$("#pyear").on('change', function(){
					var year=$(this).val();
					window.location = 'hearseReportChart.php?year='+year;
				});
			});
		</script>
	</body>
