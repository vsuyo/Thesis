...
<html lang="en">
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <div class="btn-group pull-right">
                                                    ...
                                                    <form method="post" action="clientReportChart.php">
                                                        <input type="submit" name="export2" class="btn btn-success" value="Go to Chart" />
    ...
    $conn = new mysqli("localhost", "root", "", "alisbo") or die(mysqli_error());
            $query = $conn->query("SELECT client.informant, client.date, cadaverentry.cadaverdeceased, cadaverentry.age, cadaverentry.gender, cadaverentry.birthdate FROM client  INNER JOIN cadaverentry ON client.client_id = cadaverentry.client_id" ) or die(mysqli_error());
