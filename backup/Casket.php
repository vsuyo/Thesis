...
<body>
    ...
    $query = $conn->query("SELECT cadaverentry.cadaverdeceased, client.informant, casket.choosecasket, casket.dimension, casket.type, casket.color, casket.qty, casket.price, casket.total FROM casket INNER JOIN cadaverentry ON cadaverentry.cadaverentry_id = casket.cadaverentry_id INNER JOIN client ON client.client_id = casket.client_id ") or die(mysqli_error());
...
<div class="form-group">
                                            ...
                                            <div class="col-md-9 col-xs-10">
                                                <select class="validate[required] select" name="cadaverdeceased" id="cadaverdeceased">							
...
<div class="form-group">
    <label class="col-md-3 control-label">Choose Casket</label>
    <div class="col-md-6">
        <select id="choosecasket" name = "choosecasket" class="validate [required] select">
	<option value="">Choose Casket</option>
    <option value="C">Charity</option>
    <option value="P">A Pioneer</option>
    <option value="J">Junior Half Glass</option>
    <option value="O">OMB</option>
    <option value="S">Senior Half Glass</option>
</select>
    </div>
</div>
