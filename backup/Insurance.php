                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default tabs">                            
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="active"><a href="#tab-first" role="tab" data-toggle="tab">Insurance Details</a></li>
                                </ul>                            
            ...
            <div class="modal-dialog modal-def">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="largeModalHead"><span class="fa fa-plus"> Add Insurance</span></h4>
                    </div>
                                        ...
                                        <div class="form-group">                                        
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control"/ placeholder="Insurance" name="insuranceName" id ='input' onkeyup="myFunction(this.id)" required = ""/>
                                                </div>            
                                            </div>
                                        </div>                                                      
                                        <div class="form-group">                                        
